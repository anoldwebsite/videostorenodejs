...
module.exports = function () {
    //Configuration
    if (!config.get('jwtPrivateKey')) {//On terminal in VS CODE //export vidly_mosh_jwtPrivateKey=mySecretKeyExample //You set the environment variable with export (on Mac) and set (on Windows) terminal
